...
1. Go to the [Security Advisories](https://github.com/Busnes-app/kymark-server/security/advisories) page
...
- **Vulnerability reports:** [GitHub Security Advisories](https://github.com/Busnes-app/kymark-server/security/advisories)
